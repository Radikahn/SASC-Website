  ...
  return (
    <div className="flex flex-col justify-items-center">
      <div className="rise-in">
        <span className="flex flex-1 justify-center font-normal text-6xl">
      ...
      >
        <div className="flex flex-col justify-center">
          <span className="mt-4 flex flex-1 justify-center text-lg text-center">
          ...
          <div className="w-40 flex flex-col justify-center self-center">
            <button
              className="mt-18 px-0.5 py-4 bg-neutral-50/20 cursor-pointer rounded-2xl hover:bg-neutral-50/10 transition-all duration-600 border-2 "
